...
RSpec.describe Food, type: :model do
  ...
  @recipe1 = Recipe.new(name: 'Secret Recipe', description: 'This an awesom recipe to follow', preparationTime: 15.0,
                        cookingTime: 1.0, public: true, user_id: @user1)
  subject do
    RecipeFood.new(quantity: 5, food_id: @food1, recipe_id: @recipe1)
  end
